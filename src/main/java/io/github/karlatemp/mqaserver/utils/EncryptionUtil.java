...
import io.github.karlatemp.mqaserver.jni.cipher.JavaCipher;
import io.github.karlatemp.mqaserver.protocol.packet.EncryptionRequest;
import io.github.karlatemp.mqaserver.protocol.packet.EncryptionResponse;
...
//    public static final NativeCode<BungeeCipher> nativeFactory = new NativeCode<>( "native-cipher", JavaCipher.class, NativeCipher.class );
    ...
    public static BungeeCipher getCipher(boolean forEncryption, SecretKey shared) throws GeneralSecurityException {
        BungeeCipher cipher = new JavaCipher();//nativeFactory.newInstance();
