...
public enum Protocol {
    ...
    GAME {

        {
            ...
            TO_CLIENT.registerPacket(
                    JoinGame.class,
                    map(ProtocolConstants.MINECRAFT_1_8, 0x01),
                    map(ProtocolConstants.MINECRAFT_1_9_1, 0x23),
                    map(ProtocolConstants.MINECRAFT_1_13, 0x25),
                    map(ProtocolConstants.MINECRAFT_1_15, 0x26),
                    map(ProtocolConstants.MINECRAFT_1_16, 0x25)
            );
            TO_CLIENT.registerPacket(
                    ...
                    map(ProtocolConstants.MINECRAFT_1_9_1, 0x2E),
                    map(ProtocolConstants.MINECRAFT_1_11_1, 0x2D),
    ...
    private static class ProtocolData {
        ...
        public Constructor<? extends DefinedPacket>[] getPacketConstructors() {
            return this.packetConstructors;
        }

        public boolean equals(final Object o) {
            if (o == this) return true;
            if (!(o instanceof ProtocolData)) return false;
            final ProtocolData other = (ProtocolData) o;
            if (!other.canEqual(this)) return false;
            if (this.protocolVersion != other.protocolVersion) return false;
            if (!this.packetMap.equals(other.packetMap))
                return false;
            return java.util.Arrays.deepEquals(this.packetConstructors, other.packetConstructors);
        }
        ...
        public int hashCode() {
            ...
            final Object $packetMap = this.packetMap;
            result = result * PRIME + $packetMap.hashCode();
            result = result * PRIME + java.util.Arrays.deepHashCode(this.packetConstructors);
            return result;
        }

        public String toString() {
            return "Protocol.ProtocolData(protocolVersion=" + this.protocolVersion + ", packetMap=" + this.packetMap + ", packetConstructors=" + java.util.Arrays.deepToString(this.packetConstructors) + ")";
        }
    }
    ...
    private static class ProtocolMapping {
        ...
        public boolean equals(final Object o) {
            if (o == this) return true;
            if (!(o instanceof ProtocolMapping)) return false;
        ...
        public int hashCode() {
            ...
            int result = 1;
            result = result * PRIME + this.protocolVersion;
            result = result * PRIME + this.packetID;
            return result;
        }

        public String toString() {
            return "Protocol.ProtocolMapping(protocolVersion=" + this.protocolVersion + ", packetID=" + this.packetID + ")";
        }
    }
